...
public class SquashAI extends Fighter {
    ...
    protected static final RewardData[] _dropList = new RewardData[]{
        ...
        new RewardData(9178, 1, 1, 1100), // Piggy Hat - Blessed Resurrection Effect
        new RewardData(9179, 1, 1, 1100), // Jester Hat - Blessed Resurrection Effect
        new RewardData(9180, 1, 1, 1100), // Wizard's Hat - Blessed Resurrection Effect
        new RewardData(9181, 1, 1, 1100), // Dapper Cap - Blessed Resurrection Effect
        new RewardData(9182, 1, 1, 1100), // Romantic Chapeau - Blessed Resurrection Effect
        new RewardData(9183, 1, 1, 1100), // Iron Circlet - Blessed Resurrection Effect
        new RewardData(9184, 1, 1, 1100), // Teddy Bear Hat - Blessed Escape Effect
        new RewardData(9185, 1, 1, 1100), // Piggy Hat - Blessed Escape Effect
        new RewardData(9186, 1, 1, 1100), // Jester Hat - Blessed Escape Effect
        new RewardData(9187, 1, 1, 1100), // Wizard's Hat - Blessed Escape Effect
        new RewardData(9188, 1, 1, 1100), // Dapper Cap - Blessed Escape Effect
        new RewardData(9189, 1, 1, 1100), // Romantic Chapeau - Blessed Escape Effect
        new RewardData(9190, 1, 1, 1100), // Iron Circlet - Blessed Escape Effect
        new RewardData(9191, 1, 1, 1100), // Teddy Bear Hat - Big Head
        new RewardData(9192, 1, 1, 1100), // Piggy Hat - Big Head
        new RewardData(9193, 1, 1, 1100), // Jester Hat - Big Head
        new RewardData(9194, 1, 1, 1100), // Wizard Hat - Big Head
        new RewardData(9195, 1, 1, 1100), // Dapper Hat - Big Head
        new RewardData(9196, 1, 1, 1100), // Romantic Chapeau - Big Head
        new RewardData(9197, 1, 1, 1100), // Iron Circlet - Big Head
        new RewardData(9198, 1, 1, 1100), // Teddy Bear Hat - Firework
        new RewardData(9199, 1, 1, 1100), // Piggy Hat - Firework
        new RewardData(9200, 1, 1, 1100), // Jester Hat - Firework
        new RewardData(9201, 1, 1, 1100), // Wizard's Hat - Firework
        new RewardData(9202, 1, 1, 1100), // Dapper Hat - Firework
        new RewardData(9203, 1, 1, 1100), // Romantic Chapeau - Firework
        new RewardData(9204, 1, 1, 1100), // Iron Circlet - Firework
