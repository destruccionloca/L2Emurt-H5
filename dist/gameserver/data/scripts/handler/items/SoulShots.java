...
public class SoulShots extends ScriptItemHandler implements ScriptFile {
    ...
    public boolean useItem(Playable playable, ItemInstance item, boolean ctrl) {
        ...
        if (((Config.ALLOW_SOUL_SPIRIT_SHOT_INFINITELY) || (player.hasBonus() ? PremiumConfig.getPremConfigId(player.getBonus().getBonusId()).ALLOW_SOUL_SPIRIT_SHOT_INFINITELY : false)) && count >= 1) {
