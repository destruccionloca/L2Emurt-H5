...
public class Netg {
    ...
    public static long getHashFromAddress(final InetAddress address) {
        return getHashFromIP(address.getAddress());
    }

    public static long getHashFromIP(final byte[] ip) {
        if (ip.length == 4) {
    ...
    public static byte[] getIPFromHash(final long ipHash) {
