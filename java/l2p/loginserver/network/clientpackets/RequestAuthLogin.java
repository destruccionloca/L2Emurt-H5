...
import l2p.loginserver.network.gameservercon.lspackets.GetAccountInfo;
import l2p.loginserver.network.serverpackets.LoginOk;
...
public class RequestAuthLogin extends L2LoginClientPacket {
    ...
    protected void runImpl() throws Exception {
        ...
        if (this._sessionId != client.getSessionId()) {
