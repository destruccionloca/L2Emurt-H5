...
public class CommunityBufferDAO {
    ...
    public void select() {
        ...
        try {
            ...
            while (rset.next()) {
                ...
                scheme.skills_id_lvl = ManageBbsBuffer.StringToInt(rset.getString("skills"));
    ...
    public void insert(SBufferScheme scheme, Player player) {
        ...
        String buff_list = ManageBbsBuffer.IntToString(scheme.skills_id_lvl);
        if (!Util.isMatchingRegexp(scheme.name, "[A-Za-z0-9]*")) {
        ...
        if (buff_list == null || "".equals(buff_list) || " ".equals(buff_list)) {
