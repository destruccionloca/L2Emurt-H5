...
public class SystemMessage extends L2GameServerPacket {
	...
	public static final int THIS_ITEM_IS_NOT_AVAILABLE_FOR_THE_OLYMPIAD_EVENT2 = 6508; // Данный предмет можно использовать только на олимпиаде.
        ...
        if (cha.getNpcId() <= 0) {
            if (cha.isCursedWeaponEquipped()) {
                ...
                if (cursedWeaponid == 8190) {
                    ...
                    return addString(StringUtils.defaultString(name__));
