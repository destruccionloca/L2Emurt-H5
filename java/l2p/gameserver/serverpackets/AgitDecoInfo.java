...
public class AgitDecoInfo extends L2GameServerPacket {
    ...
    /**
     * В коментах: Первое число = присланое сервером, второе уровень
     * установленый в кланхолле Пример: mp recovery: 0 = 0 значит что уровень 0
     * прислал 0, уровни 5 и 15 прислали 1, уровни 25, 35, 50 прислали 2
     *
    ...
    /**
     * Packet send, must be confirmed writeC(0xfd); writeD(0); // clanhall id
     ...
     * writeD(0); writeD(0); writeD(0); writeD(0); writeD(0);
     */
    @Override
