...
public class ExMPCCShowPartyMemberInfo extends L2GameServerPacket {
    ...
    public ExMPCCShowPartyMemberInfo(Party party) {
        ...
        members.addAll(party.getPartyMembers().stream().map(_member -> new PartyMemberInfo(_member.getName(), _member.getObjectId(), _member.getClassId().getId())).collect(Collectors.toList()));
    }
