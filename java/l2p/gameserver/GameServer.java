...
public class GameServer {
    ...
    public class GameServerListenerList extends ListenerList<GameServer> {
        ...
        public void onStart() {
            getListeners().stream().filter(listener -> OnStartListener.class.isInstance(listener)).forEach(listener -> {
                ((OnStartListener) listener).onStart();
            });
        }

        public void onShutdown() {
            getListeners().stream().filter(listener -> OnShutdownListener.class.isInstance(listener)).forEach(listener -> {
