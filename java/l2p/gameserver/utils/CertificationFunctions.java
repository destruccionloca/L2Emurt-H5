...
public class CertificationFunctions {
	...
	public static void cancelCertification(Player player) {
		cancelCertification(null, player, true);
	}
	
	public static void cancelCertification(NpcInstance npc, Player player) {
		cancelCertification(npc, player, true);
	}

    public static void cancelCertification(NpcInstance npc, Player player, boolean getPay) {
