...
public class ZoneTemplate {
    ...
    /**
     * Сообщение которое шлется при уроне от зоны (не скилла) К примеру на
     * осадах. Пока это только 686 (You have received $s1 damage from the fire
     * of magic.)
     */
    ...
    public ZoneTemplate(StatsSet set) {
        ...
        _maxlvl = set.getInteger("levelLimit", 0);
        
        String tl = set.getString("tele", null);
        if (tl != null) {
            String[] sk = tl.split(" ");
