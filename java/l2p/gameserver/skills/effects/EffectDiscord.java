...
public class EffectDiscord extends Effect {
    ...
    public boolean onActionTime() {
        List<Creature> targetList = _effected.getAroundCharacters(900, 200).stream().filter(character -> character.isNpc() && character != getEffected()).collect(Collectors.toList());
