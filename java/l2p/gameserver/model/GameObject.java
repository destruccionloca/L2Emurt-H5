...
public abstract class GameObject extends EventOwner {
    ...
    public void setObjectId(int obj) {
        objectId = obj;
    }
    ...
    /**
     * Добавляет обьект в мир, добавляет в текущий регион. Делает обьект
     * видимым.
     */
     ...
     * deleteMe. Объект после decayMe подлежит реюзу через spawnMe. Если
