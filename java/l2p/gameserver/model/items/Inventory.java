...
public abstract class Inventory extends ItemContainer {
    ...
    public int getPaperdollItemId(int slot) {
        ...
        if (item != null) {
            ...
            else if (getPaperdollItem(PAPERDOLL_RHAND) != null && getPaperdollItem(PAPERDOLL_RHAND).isVisualItem()) {
				switch (slot) {
					case PAPERDOLL_RHAND:
						return (VisualConfig.getVisualConfigId(getPaperdollItem(PAPERDOLL_RHAND).getVisualItemId()).weaponId);
				}
            } else if (getPaperdollItem(PAPERDOLL_LHAND) != null && getPaperdollItem(PAPERDOLL_LHAND).isVisualItem()) {
				switch (slot) {
					case PAPERDOLL_LHAND:
						return (VisualConfig.getVisualConfigId(getPaperdollItem(PAPERDOLL_LHAND).getVisualItemId()).weaponId);
				}
            } else if (slot == PAPERDOLL_HAIR && getPaperdollItem(PAPERDOLL_CHEST) != null && getPaperdollItem(PAPERDOLL_CHEST).getVisualItemId() != 0) {
        ...
        if (slot == PAPERDOLL_HAIR && (item = _paperdoll[PAPERDOLL_DHAIR]) != null) {
            return item.getItemId();
        }
        return 0;
    }
