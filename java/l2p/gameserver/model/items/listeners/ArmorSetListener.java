...
public final class ArmorSetListener implements OnEquipListener {
    ...
    public void onUnequip(int slot, ItemInstance item, Playable actor) {
        ...
        List<Skill> removeSkillId1 = new ArrayList<>(1); // set skill
        List<Skill> removeSkillId2 = new ArrayList<>(1); // shield skill
        List<Skill> removeSkillId3 = new ArrayList<>(1); // enchant +6 skill
