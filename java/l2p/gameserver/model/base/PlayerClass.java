...
public enum PlayerClass {
    ...
    public static EnumSet<PlayerClass> getSet(Race race, ClassLevel level) {
        ...
        allOf.addAll(EnumSet.allOf(PlayerClass.class).stream().filter(playerClass -> race == null || playerClass.isOfRace(race)).filter(playerClass -> level == null || playerClass.isOfLevel(level)).collect(Collectors.toList()));
