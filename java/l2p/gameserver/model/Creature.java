...
public abstract class Creature extends GameObject {
    ...
    public double absorbToSummon(Creature attacker, double damage) {
        ...
        if (transferToSummonDam > 0) {
            ...
            if (summon == null || summon.getCurrentHp() < transferDamage) {
    ...
    protected void onDeath(Creature killer) {
        ...
        else
        {
            for (Effect e : getEffectList().getAllEffects()) {
                if ((e.getEffectType() != EffectType.Transformation) && (!e.getSkill().isPreservedOnDeath()) && !e.getSkill().isPreservedOnDeath()) {
                    e.exit();
                }
            }
        }
