...
public class RewardData implements Cloneable {
    ...
    /**
     * Подсчет шанса выпадения этой конкретной вещи Используется в эвентах и
     * некоторых специальных механизмах
     *
    ...
    public List<RewardItem> roll(Player player, double mod) {
        ...
        if (_item.isAdena()) {
            ...
            rate = Config.RATE_DROP_EPOLET * (player != null ? player.getRateItems() : 1.);
