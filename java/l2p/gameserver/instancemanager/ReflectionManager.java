...
public class ReflectionManager {
    ...
    public static final Reflection LAST_HERO = Reflection.createReflection(-5);
    public static final Reflection TVT_EVENT = Reflection.createReflection(-6);
    public static final Reflection DEATH_MATCH = Reflection.createReflection(-7);
    ...
    private ReflectionManager() {
        ...
        // создаем в рефлекте все зоны, и все двери
        CTF_EVENT.init(DoorHolder.getInstance().getDoors(), ZoneHolder.getInstance().getZones());
        // создаем в рефлекте все зоны, и все двери
        LAST_HERO.init(DoorHolder.getInstance().getDoors(), ZoneHolder.getInstance().getZones());
        // создаем в рефлекте все зоны, и все двери
        TVT_EVENT.init(DoorHolder.getInstance().getDoors(), ZoneHolder.getInstance().getZones());
        // создаем в рефлекте все зоны, и все двери
        DEATH_MATCH.init(DoorHolder.getInstance().getDoors(), ZoneHolder.getInstance().getZones());
