...
public class LotteryManager {
    ...
    private void scheduleEndOfLottery() {
         ...
         * finishtime.setTimeInMillis(_enddate); finishtime.set(Calendar.MINUTE,
         * 0); finishtime.set(Calendar.SECOND, 0);
         * finishtime.add(Calendar.DAY_OF_MONTH, 7);
         * finishtime.set(Calendar.DAY_OF_WEEK, 6);
         * finishtime.set(Calendar.HOUR_OF_DAY, 7); _enddate =
         * finishtime.getTimeInMillis();
         *
         * ThreadPoolManager.getInstance().scheduleGeneral(new
         * stopSellingTickets(), _enddate - System.currentTimeMillis() - 10 *
         * MINUTE); ThreadPoolManager.getInstance().scheduleGeneral(new
         * finishLottery(), _enddate - System.currentTimeMillis());
		 *
         */
        Calendar finishtime = Calendar.getInstance();
