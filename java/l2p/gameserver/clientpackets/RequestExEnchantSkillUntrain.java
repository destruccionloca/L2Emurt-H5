...
public final class RequestExEnchantSkillUntrain extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        if ((_skillLvl != (oldSkillLevel - 1) || (_skillLvl / 100) != (oldSkillLevel / 100)) && !Config.ENCHANT_SKILL_TO_MAX) {
            return;
        }
        ...
        if (!Config.ENCHANT_SKILL_TO_MAX && Functions.getItemCount(activeChar, SkillTreeTable.UNTRAIN_ENCHANT_BOOK) == 0) {
