...
public class RequestExEnchantSkillInfo extends L2GameClientPacket {
    ...
    protected void runImpl() {
        ...
        if (_skillLvl > 100) {
            ...
            Skill skill = SkillTable.getInstance().getInfo(_skillId, SkillTreeTable.convertEnchantLevel(sl.getBaseLevel(), Config.ENCHANT_SKILL_TO_MAX ? realSkillMaxLevel : _skillLvl, sl.getMaxLevel()));
