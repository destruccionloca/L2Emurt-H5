    ...
    protected void runImpl() {
        ...
        try {
            for (int i = 0; i < _count; i++) {
                ...
                long price = SafeMath.mulAndCheck(item.getReferencePrice(), count) / Config.ALT_SELL_PRICE_PERCENT;
                ...
                activeChar.addAdena(Config.ALT_ENABLED_PRICE_ALL == true ? Config.ALT_ENABLED_PRICE : price);
