...
public class PlayerAI extends PlayableAI {
    ...
    public void Cast(Skill skill, Creature target, boolean forceUse, boolean dontMove) {
        ...
        if (!skill.altUse() && !skill.isToggle() && !(skill.getSkillType() == SkillType.CRAFT && Config.ALLOW_TALK_WHILE_SITTING)) // Если в этот момент встаем, то использовать скилл когда встанем
        {
            if (actor.getSittingTask()) {
